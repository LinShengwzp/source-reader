...
const ipcApiRoute = {
    ...
    writeFile: 'controller.example.writeFile',
    saveFile: 'controller.example.saveFile',
    ...
    bookSourceOperation: 'controller.reader.bookSourceOperation',
    bookSourceFileSave: 'controller.reader.bookSourceFileSave',
    bookSourceFileRead: 'controller.reader.bookSourceFileRead',

    bookGroupOperation: 'controller.reader.bookGroupOperation',
    bookInfoOperation: 'controller.reader.bookInfoOperation',
    bookGroupInfo: 'controller.reader.bookGroupInfo',
    bookInfoSave: 'controller.reader.bookInfoSave',
