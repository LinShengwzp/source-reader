            ...
            <div class="node-list">
              <transition name="slide-left">
                <el-table ref="tableNodeDataInfoRef"
                          ...
                          :data="currFile.nodeList" style="width: 100%">
                  <el-table-column :resizable="false" type="index" width="40">
                    <template #default="scope">
                  ...
                  <el-table-column :resizable="false" prop="sourceName" label="节点名称">
                    <template #header>
                  ...
                  <el-table-column :resizable="false" prop="sourceType" label="节点类型" v-if="!modifyNode.showEditor"/>
